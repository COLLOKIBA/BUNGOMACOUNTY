  ...
  const DepartmentPage: React.FC = () => {
    ...
    // CECM Data
    const CECMData = {
      name: 'Dr. Andrew Wekesa Wamalwa ',
      position: 'County Executive Committee Member, Environment, Water & Tourism',
      email: '@example.com',
      phone: '+254',
      description: (
        <div>
    ...
    return (
      <div>
        ...
        <DepartmentDescription
          departmentName="Environment, Water & Tourism"
