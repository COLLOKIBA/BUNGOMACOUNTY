...
//   `;
  ...
  const DepartmentPage: React.FC = () => {
    ...
    const ChiefOfficerData1 = {
      name: 'Mr. Edward Makhandia',
      position: 'Chief Officer, Roads, Transport, Infrastructure and Public Works',
      email: '@example.com',
      phone: '+254',
      description: 'Mr. Edward Makhandia is responsible for overseeing the ...',
      imageUrl: '/chiefhealth.jpg',
    };
    ...
    // CECM Data
    const CECMData = {
      name: 'Mr. Boniventure Chengeck',
      position: 'County Executive Committee Member, Roads, Transport, Infrastructure and Public Works',
      email: '@example.com',
      phone: '+254',
      description: (
        <div>
